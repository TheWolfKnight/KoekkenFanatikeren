...
namespace KøkkenFanatikeren {
    ...
    public partial class KitchenFanaticDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string FullName, string PhoneNumber, string Email) {
...
namespace KøkkenFanatikeren.KitchenFanaticDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([FullName] = @Ori" +
                "ginal_FullName) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email] = @Orig" +
                "inal_Email))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([FullName], [PhoneNumber], [Email]) VALUES (@FullN" +
                "ame, @PhoneNumber, @Email);\r\nSELECT Id, FullName, PhoneNumber, Email FROM Custom" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [FullName] = @FullName, [PhoneNumber] = @PhoneNumber, [Email] = @Email WHERE (([Id] = @Original_Id) AND ([FullName] = @Original_FullName) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email] = @Original_Email));
SELECT Id, FullName, PhoneNumber, Email FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::KøkkenFanatikeren.Properties.Settings.Default.KitchenFanaticConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, PhoneNumber, Email FROM dbo.Customers";
        ...
        public virtual int Fill(KitchenFanaticDataSet.CustomersDataTable dataTable) {
        ...
        public virtual KitchenFanaticDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KitchenFanaticDataSet.CustomersDataTable dataTable = new KitchenFanaticDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KitchenFanaticDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FullName, string Original_PhoneNumber, string Original_Email) {
        ...
        public virtual int Update(string FullName, string PhoneNumber, string Email, int Original_Id, string Original_FullName, string Original_PhoneNumber, string Original_Email, int Id) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string PhoneNumber, string Email, int Original_Id, string Original_FullName, string Original_PhoneNumber, string Original_Email) {
            return this.Update(FullName, PhoneNumber, Email, Original_Id, Original_FullName, Original_PhoneNumber, Original_Email, Original_Id);
        }
    }
